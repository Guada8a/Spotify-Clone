...
const SongControl = ({audio}) => {
    ...
    return (
        <div className="flex gap-x-3 text-xs pt-2">
            <span className="opacity-50 w-11 text-right">{formatTime(currentTime)}</span>
            <Slider
                defaultValue={[0]}
            ...
            />
            {duration ? <span className="opacity-50 w-11 text-left">{formatTime(duration)}</span>: <span className="opacity-50 w-11 text-left">00:00</span>}
        </div>
    )
